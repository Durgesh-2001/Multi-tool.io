...
import { checkAndExpireUserSubscription } from '../utils/subscriptionManager.js';
...
router.post('/google', async (req, res) => {
  ...
  try {
    ...
    // ✅ CHECK AND EXPIRE SUBSCRIPTION ON GOOGLE LOGIN
    await checkAndExpireUserSubscription(user._id);
    
    // Refresh user data after potential subscription update
...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    // ✅ CHECK AND EXPIRE SUBSCRIPTION ON LOGIN
    await checkAndExpireUserSubscription(user._id);
