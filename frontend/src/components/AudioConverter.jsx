          ...
          {conversionType === 'youtube' ? (
            ...
            <div className="audio-conv__file">
              ...
              <div
                ...
                tabIndex={0}
                role="button"
                aria-label="Video file drop zone. Press Enter or Space to open file picker."
                onKeyDown={(e) => {
              ...
              >
                ...
                <div id="video-file-hint" className="audio-conv__file-hint">Supports MP4, AVI, MOV, MKV, and other video formats</div>
                <div className="audio-conv__file-formats">Max file size: 100MB</div>
                <button
                  type="button"
                  className="audio-conv__browse-btn"
